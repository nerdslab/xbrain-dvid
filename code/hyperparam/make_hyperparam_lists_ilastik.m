...
pthresh_file = 'pthresh_file2.list';
ballsz_init_file = 'ballsz_init_file2.list';
ballsz_small_file = 'ballsz_small_file2.list';
ballsz_large_file = 'ballsz_large_file2.list';
presid_file = 'presid_file2.list';
bgfg_mode_file = 'bgfg_mode_file2.list';
